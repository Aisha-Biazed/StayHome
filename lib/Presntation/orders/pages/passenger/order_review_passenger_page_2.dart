...
class _OrderReviewPassengerPage2State extends State<OrderReviewPassengerPage2> {
  ...
  Widget build(BuildContext context) {
    InitialCubit.get(context).orderCheckCubit(
        ...
        InitialCubit.get(context).idSourceCubit);
    return BlocBuilder<InitialCubit, InitialStates>(
      builder: (context, state) {
        var destinationController = TextEditingController(
            text:
                '${AppStrings.destinationText}${InitialCubit.get(context).nameDestinationCubit}');
        var sourceController = TextEditingController(
            text:
                '${AppStrings.sourceText}${InitialCubit.get(context).nameSourceCubit}');
        var noteController =
            TextEditingController(text: InitialCubit.get(context).noteCubit);
        return Scaffold(
            ...
            child: Padding(
              ...
              child: Stack(
                children: [
                  ...
                  Container(
                    margin:
                        REdgeInsetsDirectional.only(top: 650, end: 0, start: 0),

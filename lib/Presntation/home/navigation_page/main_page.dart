...
class _MainPageState extends State<MainPage> {
  List<CardItem> items = [
    CardItem(urlImage: ImageAssets.home_img2),
    CardItem(urlImage: ImageAssets.home_img1)
  ];

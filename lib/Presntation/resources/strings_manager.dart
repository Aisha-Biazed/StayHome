class AppStrings {
  ...
  static const onBoardingSubTitle1 =
      "تتمتع خدمتنا بميزة الكفاءة والقدرة على التوصيل بسهولة وبأقل التكاليف";
  static const onBoardingSubTitle2 =
      "تتمتع خدمتنا بميزة التوصيل الآمن وبسرعة والثقة الفعلية ";
  static const onBoardingButton1 = "تخطي";
